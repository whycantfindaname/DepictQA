...
# Define common paths
meta_folder="dataset/clean_data_v1"
image_folder="/home/liaowenjie/桌面/画质大模型/datasets/images/single_1w"
save_folder='dataset/clean_data_v1'
...
#     --assess_file $save_folder/assessment.json \
#     --image_folder $image_folder \
#     --output_file $save_folder/qwen_single/qwen_no_bbox.json \
#     --keep_mos True \
#     --bbox_provided False \
